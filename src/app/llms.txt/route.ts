...
export async function GET() {
  ...
  lines.push(`## ${lt('pages')} (TR)`, `- ${at('nav.home')}: ${link('/', 'tr')}`, `- ${at('nav.services')}: ${link('/services', 'tr')}`, `- ${at('nav.solutions')}: ${link('/solutions', 'tr')}`, `- ${at('nav.pricing')}: ${link('/pricing', 'tr')}`, `- ${at('nav.projects')}: ${link('/projects', 'tr')}`, `- ${at('nav.blog')}: ${link('/blog', 'tr')}`, `- ${at('nav.faq')}: ${link('/faq', 'tr')}`, `- ${at('nav.leads')}: ${link('/contact', 'tr')}`, `- ${at('formSettings.title')}: ${link('/get-quote', 'tr')}`, '');
  lines.push(`## ${le('pages')} (EN)`, `- ${ae('nav.home')}: ${link('/', 'en')}`, `- ${ae('nav.services')}: ${link('/services', 'en')}`, `- ${ae('nav.solutions')}: ${link('/solutions', 'en')}`, `- ${ae('nav.pricing')}: ${link('/pricing', 'en')}`, `- ${ae('nav.projects')}: ${link('/projects', 'en')}`, `- ${ae('nav.blog')}: ${link('/blog', 'en')}`, `- ${ae('nav.leads')}: ${link('/contact', 'en')}`, '');
