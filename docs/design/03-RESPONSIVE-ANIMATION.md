...
|---|---|---|---|
| **Header** | Hamburger · logo ortada · CTA ikon | Hamburger · CTA metinli | Sol grup / logo / sağ grup + mega menü |
| **Video Hero** | `100dvh` · **scrub yok, otomatik oynatma** | scrub, düşük çözünürlük | Tam scrub + pin |
